(window.webpackJsonp=window.webpackJsonp||[]).push([[7],{1005:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.d(__webpack_exports__,"a",function(){return ByteSize});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(0),_util_internal_locale_NumberFormatter__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(976);class ByteSize extends react__WEBPACK_IMPORTED_MODULE_0__.Component{render(){return this.props.format.replace(/%d/,(new _util_internal_locale_NumberFormatter__WEBPACK_IMPORTED_MODULE_1__.a).format(this.props.children,this.props.locale))}}},1016:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.d(__webpack_exports__,"a",function(){return UsdValue});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(0);class UsdValue extends react__WEBPACK_IMPORTED_MODULE_0__.Component{render(){const{value:value,locale:locale}=this.props;return value.toLocaleString(locale,{currency:"USD",currencyDisplay:"symbol",style:"currency"})}}},1054:function(module,__webpack_exports__,__webpack_require__){"use strict";var react=__webpack_require__(0),ValueBox=__webpack_require__(962),Hash=__webpack_require__(973),tslib_es6=__webpack_require__(9),TooltipBase=__webpack_require__(980),styled_components=__webpack_require__(960);const TooltipTextRoot=Object(styled_components.b)("div").withConfig({displayName:"TooltipTextRoot",componentId:"sc-8p2egb"})`
    font-size: 16px;
    line-height: 32px;
    font-weight: 500;
...
`;var react_is=__webpack_require__(94);__webpack_require__.d(__webpack_exports__,"a",function(){return LayoutRowItem_LayoutRowItem});const LayoutRowItemWrapper=Object(styled_components.b)(({children:children,className:className})=>react.createElement("div",{className:className},children)).withConfig({displayName:"LayoutRowItemWrapper",componentId:"sc-1a68aag"})`
    display: flex;
    flex: ${props=>props.fullRow?"1 1":"0 0"} auto;
`,LayoutInfoBoxItem=Object(styled_components.b)(({children:children,className:className})=>react.createElement("div",{className:className},children)).withConfig({displayName:"LayoutInfoBoxItem",componentId:"sc-15va7f1"})`
    display: flex;
    flex: ${({fullRow:fullRow})=>fullRow?"1 1":"0 1"} auto;
    flex-wrap: wrap;
`;class LayoutRowItem_LayoutRowItem extends react.PureComponent{render(){const childrenArray=react.Children.toArray(this.props.children).reduce((outArr,child)=>(react_is.isFragment(child)?outArr.push(...react.Children.map(child.props.children,c=>react_is.isElement(c)?react.cloneElement(c,{}):(console.error("Fragment passed to LayoutRowItem contains a child that is not a React.Element.",c),c))):outArr.push(child),outArr),[]),labelElement=childrenArray.shift();return react.createElement(LayoutRowItemWrapper,{fullRow:this.props.fullRow},this.props.ignoreFirstLabel?null:react.createElement(LayoutBoxItem,{isBeginningOfRow:this.props.isBeginningOfRow,baseHeight:this.props.baseHeight,autoWidth:this.props.autoWidth},labelElement),1===childrenArray.length?this.childrenArrayRender(childrenArray):react.createElement(LayoutInfoBoxItem,{fullRow:this.props.fullRow},this.childrenArrayRender(childrenArray)))}childrenArrayRender(children){return children.map((c,idx)=>react.createElement(LayoutBoxItem,{baseHeight:this.props.baseHeight,autoHeight:this.props.autoHeight,autoWidth:this.props.autoWidth,key:idx},c))}}LayoutRowItem_LayoutRowItem._brand="layoutRowItem"},1061:function(module,__webpack_exports__,__webpack_require__){"use strict";var react=__webpack_require__(0),styled_components=__webpack_require__(960);const Spacer=Object(styled_components.b)(({children:children,className:className})=>react.createElement("div",{className:className},children)).withConfig({displayName:"Spacer",componentId:"sc-4rpf73"})`
    height: ${props=>props.height};
    flex: 0 0 auto;
`;__webpack_require__.d(__webpack_exports__,"a",function(){return LayoutSection_LayoutSection});const LayoutSectionWrapper=styled_components.b.div.withConfig({displayName:"LayoutSectionWrapper",componentId:"sc-1b8183u"})`
    flex: 1 1 auto;
    box-sizing: border-box;
`;class LayoutSection_LayoutSection extends react.Component{render(){return react.Children.toArray(this.props.children).length?react.createElement(react.Fragment,null,this.props.useWrapper?react.createElement(LayoutSectionWrapper,null,this.props.children):this.props.children,react.createElement(Spacer,{height:"48px"})):null}}},962:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.d(__webpack_exports__,"a",function(){return ValueBox});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(0),_Box__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(979),_styled_components__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(960);const ValueBox=Object(_styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(({children:children,className:className,Icon:Icon,iconPlacement:iconPlacement,variant:variant,colors:colors,borderStyle:borderStyle,fullWidth:fullWidth,theme:theme})=>react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Box__WEBPACK_IMPORTED_MODULE_1__.a,{className:className,metrics:theme.spacing.valueBoxMetrics[variant],colors:"string"==typeof colors?theme.colors.valueBox[colors]:colors,borderStyle:borderStyle,Icon:Icon,iconPlacement:iconPlacement,fullWidth:fullWidth},children));ValueBox.defaultProps={variant:"normal",colors:"primary",borderStyle:"solid"}},965:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.d(__webpack_exports__,"a",function(){return SvgIcon});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(0);class SvgIcon extends react__WEBPACK_IMPORTED_MODULE_0__.Component{render(){let size=this.props.size,viewBoxSize=this.props.viewBoxSize;return react__WEBPACK_IMPORTED_MODULE_0__.createElement("svg",{width:size+"px",height:size+"px",style:{display:"block"},viewBox:`0 0 ${viewBoxSize} ${viewBoxSize}`,version:"1.1",xmlns:"http://www.w3.org/2000/svg"},this.props.children)}}SvgIcon.defaultProps={size:24,viewBoxSize:24}},973:function(module,__webpack_exports__,__webpack_require__){"use strict";var react=__webpack_require__(0),styled_components=__webpack_require__(960);__webpack_require__.d(__webpack_exports__,"a",function(){return Hash_Hash});const HiddenHashPartWrapper=styled_components.b.span.withConfig({displayName:"HiddenHashPartWrapper",componentId:"sc-4zoryo"})`
    &:before {
        content: " ... ";
    }
`,HiddenHashPart=styled_components.b.strong.withConfig({displayName:"HiddenHashPart",componentId:"sc-1uf7egn"})`
    ...
    pointer-events: none;
    font-size: 0;
`;class Hash_Hash extends react.PureComponent{constructor(){super(...arguments),this.handleCopy=e=>{e.preventDefault(),e.clipboardData.setData("text/plain","0x"+this.props.children)}}render(){let{children:children}=this.props,hash="0x"+children.replace(/^0x/,""),chars=this.props.ellipsisChars,hashParts=function splitLongHash(hash,threshold,charsShown){return!(hash.length<=threshold||threshold<2*charsShown)&&[hash.substr(0,charsShown),hash.substr(charsShown,hash.length-2*charsShown),hash.substr(-charsShown)]}(hash,this.props.ellipsisThreshold,chars);return react.createElement("span",{onCopy:this.handleCopy},this.props.useEllipsis&&hashParts?react.createElement(react.Fragment,null,hashParts[0],react.createElement(HiddenHashPartWrapper,null,react.createElement(HiddenHashPart,null,hashParts[1])),hashParts[2]):hash)}}Hash_Hash.defaultProps={ellipsisThreshold:20,ellipsisChars:6,useEllipsis:!0}},975:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.d(__webpack_exports__,"a",function(){return Number});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(0),_util_internal_locale_NumberFormatter__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(976),_util_internal_locale_BigNumberFormatter__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(977);class Number extends react__WEBPACK_IMPORTED_MODULE_0__.Component{render(){let{value:value,locale:locale}=this.props;return"number"!=typeof value?(new _util_internal_locale_BigNumberFormatter__WEBPACK_IMPORTED_MODULE_2__.a).format(value,locale):(new _util_internal_locale_NumberFormatter__WEBPACK_IMPORTED_MODULE_1__.a).format(value,locale)}}},976:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.d(__webpack_exports__,"a",function(){return NumberFormatter});class NumberFormatter{format(value,locale){return value.toLocaleString(locale)}}},977:function(module,__webpack_exports__,__webpack_require__){"use strict";function getNumberSeparator(locale,separatorType){let numberFormat=Intl.NumberFormat(locale);return numberFormat.formatToParts?numberFormat.formatToParts(1000.1).find(part=>part.type===separatorType).value:"group"===separatorType?1e3.toLocaleString().replace(/[0-9]/g,""):1.1.toLocaleString().replace(/[0-9]/g,"")}__webpack_require__.d(__webpack_exports__,"a",function(){return BigNumberFormatter_BigNumberFormatter});class BigNumberFormatter_BigNumberFormatter{static getBnFormat(locale){let fmt=this.formats.get(locale);return fmt||(fmt={decimalSeparator:getNumberSeparator(locale,"decimal"),groupSeparator:getNumberSeparator(locale,"group"),groupSize:3},this.formats.set(locale,fmt)),fmt}format(num,locale,options={}){let fmt=BigNumberFormatter_BigNumberFormatter.getBnFormat(locale);if(num=num.decimalPlaces(void 0!==options.maximumFractionDigits?options.maximumFractionDigits:3),void 0!==options.minimumFractionDigits){if(num.decimalPlaces()<options.minimumFractionDigits)return num.toFormat(options.minimumFractionDigits,fmt)}return num.toFormat(fmt)}}BigNumberFormatter_BigNumberFormatter.formats=new Map},978:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.d(__webpack_exports__,"a",function(){return Label});var _styled_components__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(960),react__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(0);const Label=Object(_styled_components__WEBPACK_IMPORTED_MODULE_0__.b)(({children:children,className:className})=>react__WEBPACK_IMPORTED_MODULE_1__.createElement("div",{className:className},children)).withConfig({displayName:"Label",componentId:"sc-1npcbvl"})`
    font-size: 12px;
    line-height: 12px;
    height: 12px;
    ...
    `:""}
`;Label.defaultProps={uppercase:!0}},979:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.d(__webpack_exports__,"a",function(){return Box});var _styled_components__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(960),react__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(0);const IconRoot=_styled_components__WEBPACK_IMPORTED_MODULE_0__.b.div.withConfig({displayName:"IconRoot",componentId:"sc-1x8jexb"})`
    display: block;
    ...
    pointer-events: none;
`,ContentRoot=Object(_styled_components__WEBPACK_IMPORTED_MODULE_0__.b)("div").withConfig({displayName:"ContentRoot",componentId:"sc-1h36b7j"})`
...
`,getColors=(colors,theme)=>"function"==typeof colors?colors(theme):colors,Box=Object(_styled_components__WEBPACK_IMPORTED_MODULE_0__.b)(({children:children,className:className,Icon:Icon,iconPlacement:iconPlacement,metrics:metrics,fullWidth:fullWidth})=>{let icon=Icon?react__WEBPACK_IMPORTED_MODULE_1__.createElement(IconRoot,null,react__WEBPACK_IMPORTED_MODULE_1__.createElement(Icon,{size:metrics.iconSize})):null,iconIsLeft="left"===iconPlacement;return react__WEBPACK_IMPORTED_MODULE_1__.createElement("div",{className:className},iconIsLeft&&icon,void 0!==children?react__WEBPACK_IMPORTED_MODULE_1__.createElement(ContentRoot,{fullWidth:fullWidth,paddingTop:metrics.textPaddingTop},children):null,!iconIsLeft&&icon)}).withConfig({displayName:"Box",componentId:"sc-p4qq1s"})`
    ...
    border: ${1}px ${props=>props.borderStyle||"solid"} ${props=>getColors(props.colors,props.theme).border||getColors(props.colors,props.theme).background||"transparent"};
